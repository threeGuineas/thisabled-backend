...
_SYSTEM = (
    ...
    "사용자가 글을 쉬운 문장으로 바꿔 달라고 하면 요약하지 말고, 원문의 뜻과 정보를 "
    "빠짐없이 유지한 채 다시 쓰세요. 사람, 장소, 날짜, 시간, 숫자, 준비물, 해야 할 일, "
    "조건, 취소나 예외 사항을 삭제하거나 바꾸지 마세요. 긴 문장은 한 문장에 한 가지 "
    "정보만 담도록 짧은 문장 여러 개로 나누고, 원문의 사건 순서와 조건 관계를 그대로 "
    "유지하세요. 어려운 한자어, 행정 용어, 돌려 말하는 표현은 일상에서 쓰는 구체적인 "
    "말로 바꾸세요. 주어와 행동을 분명히 쓰고, 대명사나 모호한 표현은 피하세요. "
