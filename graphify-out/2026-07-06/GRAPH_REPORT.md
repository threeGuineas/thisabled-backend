...
## Corpus Check
- 54 files · ~22,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 513 nodes · 746 edges · 62 communities (45 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33d0c346`
...
Cohesion: 0.08
Nodes (27): get_redis(), get_redis_client(), Redis, FastAPI 의존성. 테스트에서 override 가능하도록 분리., AsyncClient, auth_header(), client(), db() (+19 more)

### Community 1 - "Auth Endpoints & JWT Security"
Cohesion: 0.20
Nodes (27): me(), _me_out(), patch_me(), patch_settings(), public_profile(), put_mode(), put_tags(), AsyncSession (+19 more)
...
- **What connects `ACC-03 프로필 · TAG-01 태그 · §15 설정 · §5.2 모드 변경.`, `본인 조회 — ui_mode·is_minor 등 민감 파생값 포함 (타인 조회와 분리).`, `타인 프로필 — 장애 유형·UI 모드·생년월일 비노출 (ACC-03, §5.2).` to the rest of the system?**
